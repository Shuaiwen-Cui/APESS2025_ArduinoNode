...
git add .
git status
git commit -m 'auto update by upload.sh'
echo '--------commit successfully--------'

git push -f https://github.com/Shuaiwen-Cui/APESS2025_ArduinoNode.git main
# git push -u https://github.com/Shuaiwen-Cui/APESS2025_ArduinoNode.git main
# git remote add origin https://github.com/Shuaiwen-Cui/APESS2025_ArduinoNode.git
